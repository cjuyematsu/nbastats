//app/games/six-degrees/opengraph-image.tsx
  ...
  return new ImageResponse(
    (
      ...
      >
        ...
        <div style={{ display: 'flex', fontSize: 80, fontWeight: 700 }}>Six Degrees of NBA</div>
        <div style={{ display: 'flex', fontSize: 38, color: '#cbd5e1', marginTop: 32 }}>
          Connect two NBA players through former teammates
        </div>

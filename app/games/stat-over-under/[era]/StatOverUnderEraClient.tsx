//games/stat-over-under/[era]/StatOverUnderEraClient.tsx
    ...
    return (
      <div className={`w-full rounded-lg min-h-screen flex flex-col items-center justify-center py-12 px-4 ${mainContainerClasses} border border-gray-200 dark:border-gray-700`}>
        <div className={`max-w-lg w-full mx-auto p-6 sm:p-8 rounded-xl shadow-2xl text-center backdrop-blur-md animate-fadeIn ${cardBg}`}>
            <h2 className={`text-3xl font-bold mb-2 ${highlightColor}`}>{isCompleted ? 'Game Over!' : 'Game Already Played!'}</h2>
            <p className={`text-xl font-medium mb-2 ${mutedText}`}>{eraName} - {todayDateISO}</p>
    ...
    <div className={`w-full rounded-lg ${mainContainerClasses} border border-gray-200 dark:border-gray-700`}>
      <div className={`flex flex-col items-center justify-center min-h-screen rounded-lg shadow-2xl py-8 px-4 ${mainBg}`}>
        <div className="w-full max-w-lg">
            ...
            <h2 className={`text-2xl md:text-3xl font-bold text-center mb-1 ${highlightColor}`}>{eraName}</h2>

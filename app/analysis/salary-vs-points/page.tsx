...
const bestValueAll = [
  { name: 'Drew Timme', dpp: 1037.20, salary: 113055, pts: 109, games: 9 },
  { name: 'Tosan Evbuomwan', dpp: 1241.07, salary: 331365, pts: 267, games: 28 },
  { name: 'Jaylen Wells', dpp: 1406.02, salary: 1157153, pts: 823, games: 79 },
  { name: 'Jaylen Sims', dpp: 1741.74, salary: 73153, pts: 42, games: 6 },
  { name: 'Tristan Vukcevic', dpp: 1753.26, salary: 578577, pts: 330, games: 35 },
  { name: 'Justin Edwards', dpp: 1758.92, salary: 782721, pts: 445, games: 44 },
  { name: 'Damion Baugh', dpp: 1800.41, salary: 196245, pts: 109, games: 15 },
  { name: 'Tyrese Martin', dpp: 1835.05, salary: 959732, pts: 523, games: 60 },
  { name: 'Marcus Bagley', dpp: 1885.91, salary: 126356, pts: 67, games: 10 },
  { name: 'Jeff Dowtin Jr.', dpp: 2030.09, salary: 578577, pts: 285, games: 41 }
];

const worstValueAll = [
  { name: 'P.J. Tucker', dpp: 1351730.78, salary: 12165577, pts: 9, games: 3 },
  { name: 'Taylor Hendricks', dpp: 417740.43, salary: 5848366, pts: 14, games: 3 },
  { name: 'James Johnson', dpp: 412971.38, salary: 3303771, pts: 8, games: 12 },
  { name: 'James Wiseman', dpp: 372948.50, salary: 2237691, pts: 6, games: 1 },
  { name: 'Daishen Nix', dpp: 362356.00, salary: 362356, pts: 1, games: 3 },
  { name: 'Joe Ingles', dpp: 220251.40, salary: 3303771, pts: 15, games: 19 },
  { name: 'De\'Anthony Melton', dpp: 206806.45, salary: 12822000, pts: 62, games: 6 },
  { name: 'Tristen Newton', dpp: 192859.00, salary: 578577, pts: 3, games: 8 },
  { name: 'Quincy Olivari', dpp: 192859.00, salary: 578577, pts: 3, games: 2 },
  { name: 'Mitchell Robinson', dpp: 164576.80, salary: 14318182, pts: 87, games: 17 }
];

const bestValue50Games = [
  { name: 'Jaylen Wells', dpp: 1406.02, salary: 1157153, pts: 823, games: 79 },
  { name: 'Tyrese Martin', dpp: 1835.05, salary: 959732, pts: 523, games: 60 },
  { name: 'Jared Butler', dpp: 2062.29, salary: 1115697, pts: 541, games: 60 },
  { name: 'Toumani Camara', dpp: 2144.96, salary: 1891857, pts: 882, games: 78 },
  { name: 'Jalen Wilson', dpp: 2525.84, salary: 1891857, pts: 749, games: 79 },
  { name: 'Christian Braun', dpp: 2536.65, salary: 3089640, pts: 1218, games: 79 },
  { name: 'Keon Johnson', dpp: 2577.60, salary: 2162606, pts: 839, games: 79 },
  { name: 'Scotty Pippen Jr.', dpp: 2679.74, salary: 2087519, pts: 779, games: 79 },
  { name: 'Guerschon Yabusele', dpp: 2718.12, salary: 2087519, pts: 768, games: 70 },
  { name: 'Ty Jerome', dpp: 2916.83, salary: 2560975, pts: 878, games: 70 }
];

const worstValue50Games = [
  { name: 'Ben Simmons', dpp: 157570.88, salary: 40338144, pts: 256, games: 51 },
  { name: 'Jonathan Isaac', dpp: 72631.58, salary: 27600000, pts: 380, games: 71 },
  { name: 'Steven Adams', dpp: 56000.00, salary: 12600000, pts: 225, games: 57 },
  { name: 'Bradley Beal', dpp: 55658.46, salary: 50203930, pts: 902, games: 53 },
  { name: 'Fred VanVleet', dpp: 50766.13, salary: 42846615, pts: 844, games: 60 },
  { name: 'Jimmy Butler', dpp: 50621.03, salary: 48798677, pts: 964, games: 55 },
  { name: 'Rudy Gobert', dpp: 50609.22, salary: 43827586, pts: 866, games: 72 },
  { name: 'Zeke Nnaji', dpp: 48309.18, salary: 8888889, pts: 184, games: 57 },
  { name: 'Isaiah Hartenstein', dpp: 47095.76, salary: 30000000, pts: 637, games: 57 },
  { name: 'Clint Capela', dpp: 45625.57, salary: 22265280, pts: 488, games: 55 }
];

const starPlayers = [
  { name: 'Shai Gilgeous-Alexander', dpp: 14436.37, salary: 35859950, pts: 2484, games: 76 },
  { name: 'Jalen Brunson', dpp: 14769.23, salary: 24960001, pts: 1690, games: 65 },
  { name: 'Jayson Tatum', dpp: 18037.44, salary: 34848340, pts: 1932, games: 72 },
  { name: 'Anthony Edwards', dpp: 19373.63, salary: 42176400, pts: 2177, games: 79 },
  { name: 'Giannis Antetokounmpo', dpp: 23962.51, salary: 48787676, pts: 2036, games: 67 },
  { name: 'Nikola Jokic', dpp: 24826.62, salary: 51415938, pts: 2071, games: 70 },
  { name: 'LeBron James', dpp: 28496.40, salary: 48728845, pts: 1710, games: 70 },
  { name: 'Luka Doncic', dpp: 30562.46, salary: 43031940, pts: 1408, games: 50 },
  { name: 'Kevin Durant', dpp: 31074.09, salary: 51179020, pts: 1647, games: 62 },
  { name: 'Stephen Curry', dpp: 32457.05, salary: 55761217, pts: 1718, games: 70 }
];
    ...
    <div className="p-4 bg-white dark:bg-gray-800 rounded-lg shadow">
        ...
        <ResponsiveContainer width="100%" height={400}>
            <BarChart data={data} layout="vertical" margin={{ top: 5, right: 30, left: 50, bottom: 5 }}>
                ...
                />
                <Legend />
                <Bar dataKey="dpp" name="Dollars per Point" fill={barColor} />
            </BarChart>
        </ResponsiveContainer>
    </div>
);
        ...
        <div className="bg-gray-50 dark:bg-gray-900 text-gray-900 dark:text-gray-100 min-h-screen p-4 sm:p-6 lg:p-8">
            <div className="max-w-7xl mx-auto">
                ...
                <article className="space-y-12">
                    <section>
                        <h2 className="text-2xl font-bold mb-4">The &quot;Dollars per Point&quot; Metric</h2>
                    ...
                    <section>
                        <h2 className="text-2xl font-bold mb-4">Factoring in Playing Time</h2>
                        <p className="text-base text-gray-700 dark:text-gray-300 leading-relaxed">
                    ...
                    <section>
                        <h2 className="text-2xl font-bold mb-4">How do the Best Players Compare?</h2>
                        <p className="text-base text-gray-700 dark:text-gray-300 leading-relaxed">

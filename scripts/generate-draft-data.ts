...
async function main() {
  ...
  const file = `// Generated by scripts/generate-draft-data.ts. Draft pick history sourced from
// Wikipedia NBA draft pages (the draft table); career scoring computed from our
// regularseasonstats database.
